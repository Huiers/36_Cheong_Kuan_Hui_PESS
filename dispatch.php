<?php
	...
	$sql = "SELECT patrolcar.patrolcar_id,patrolcar_status_desc FROM `patrolcar` INNER JOIN patrolcar_status ON patrolcar.patrolcar_status_id = patrolcar_status.patrolcar_status_id";
	...
	$btnProcessDispatchClicked = isset($_POST["btnProcessCall"]);
